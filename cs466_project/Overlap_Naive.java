...
public class Overlap_Naive {
	...
	public Overlap_Naive(String[] A) {
		Map m = this.getEdge(A);
		this.res = this.getString(m);
	}
	...
	private Map<String, List<Edge>> getEdge(String[] keys) {
	...
	private String getString(Map<String, List<Edge>> edges) {
...
//		String[] keys = tmp.toArray(new String[0]);
		Overlap_Naive solution = new Overlap_Naive(keys);
		long start = System.currentTimeMillis();
		String result = solution.getString();
