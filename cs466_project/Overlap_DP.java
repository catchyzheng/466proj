...
////		String[] keys = tmp.toArray(new String[0]);
		generate_data gd = new generate_data(18, 4);
		String[] keys = gd.getKeys("OG");
		String data = gd.getOriginal();
		System.out.println(data);
//		System.out.println(keys.length);
		
		Overlap_DP solution = new Overlap_DP(keys);
		long start = System.currentTimeMillis();
		String res = solution.getString();
